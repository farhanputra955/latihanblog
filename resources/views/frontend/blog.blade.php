...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="{{ asset ('assets/blog/img/core-img/favicon.ico')}}">
...
<body>
    ...
    <header class="header-area">
        ...
        <div class="logo-area text-center">
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-12">
                        <a href="index.html" class="original-logo"><img src="{{ asset ('assets/blog/img/core-img/iop.png')}}" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-end">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-catagory-area clearfix mb-100">
                        <img src="{{ asset ('assets/blog/img/blog-img/1.jpg')}}" alt="">
                        <!-- Catagory Title -->
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-catagory-area clearfix mb-100">
                        <img src="{{ asset ('assets/blog/img/blog-img/2.jpg')}}" alt="">
                        <!-- Catagory Title -->
                ...
                <div class="col-12 col-lg-9">
                    ...
                    <div class="single-blog-area blog-style-2 mb-50 wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="1000ms">
                        <div class="row">
                            <div class="col-12">
                                <div class="single-blog-thumbnail">
                                    <img src="{{ asset ('assets/blog/img/blog-img/7.jpg')}}" alt="">
                                    <div class="post-date">
                    ...
                    <div class="single-blog-area blog-style-2 mb-50 wow fadeInUp" data-wow-delay="0.5s" data-wow-duration="1000ms">
                        <div class="row align-items-center">
                            <div class="col-12 col-md-6">
                                <div class="single-blog-thumbnail">
                                    <img src="{{ asset ('assets/blog/img/blog-img/5.jpg')}}" alt="">
                                    <div class="post-date">
                    ...
                    <div class="single-blog-area blog-style-2 mb-50 wow fadeInUp" data-wow-delay="0.6s" data-wow-duration="1000ms">
                        <div class="row align-items-center">
                            <div class="col-12 col-md-6">
                                <div class="single-blog-thumbnail">
                                    <img src="{{ asset ('assets/blog/img/blog-img/6.jpg')}}" alt="">
                                    <div class="post-date">
                                        <a href="#">12 <span>march</span></a>
                                    </div>
                                </div>
                ...
                <div class="col-12 col-md-4 col-lg-3">
                    <div class="post-sidebar-area">
                        ...
                        <div class="sidebar-widget-area">
                            ...
                            <a href="#"><img src="/assets/blog/img/bg-img/add.gif" alt=""></a>
                        </div>
    ...
    <div class="instagram-feed-area">
        ...
        <div class="instagram-slides owl-carousel">
            ...
            <div class="single-insta-feed">
                <img src="{{ asset ('assets/blog/img/instagram-img/1.png')}}" alt="">
                <!-- Hover Effects -->
            ...
            <!-- Single Insta Feed -->
            <div class="single-insta-feed">
                <img src="{{ asset ('assets/blog/img/instagram-img/2.png')}}" alt="">
                <!-- Hover Effects -->
                <div class="hover-effects">
                    <a href="#" class="d-flex align-items-center justify-content-center"><i class="fa fa-instagram"></i></a>
                </div>
            ...
            <!-- Single Insta Feed -->
            <div class="single-insta-feed">
                <img src="{{ asset ('assets/blog/img/instagram-img/3.png')}}" alt="">
                <!-- Hover Effects -->
                <div class="hover-effects">
                    <a href="#" class="d-flex align-items-center justify-content-center"><i class="fa fa-instagram"></i></a>
                </div>
            ...
            <!-- Single Insta Feed -->
            <div class="single-insta-feed">
                <img src="{{ asset ('assets/blog/img/instagram-img/4.png')}}" alt="">
                <!-- Hover Effects -->
                <div class="hover-effects">
                    <a href="#" class="d-flex align-items-center justify-content-center"><i class="fa fa-instagram"></i></a>
                </div>
            ...
            <!-- Single Insta Feed -->
            <div class="single-insta-feed">
                <img src="{{ asset ('assets/blog/img/instagram-img/5.png')}}" alt="">
                <!-- Hover Effects -->
                <div class="hover-effects">
                    <a href="#" class="d-flex align-items-center justify-content-center"><i class="fa fa-instagram"></i></a>
                </div>
            ...
            <!-- Single Insta Feed -->
            <div class="single-insta-feed">
                <img src="{{ asset ('assets/blog/img/instagram-img/6.png')}}" alt="">
                <!-- Hover Effects -->
                <div class="hover-effects">
                    <a href="#" class="d-flex align-items-center justify-content-center"><i class="fa fa-instagram"></i></a>
                </div>
            ...
            <!-- Single Insta Feed -->
            <div class="single-insta-feed">
                <img src="{{ asset ('assets/blog/img/instagram-img/7.png')}}" alt="">
                <!-- Hover Effects -->
                <div class="hover-effects">
                    <a href="#" class="d-flex align-items-center justify-content-center"><i class="fa fa-instagram"></i></a>
                </div>
    ...
    <script src="{{ asset ('assets/blog/js/jquery/jquery-2.2.4.min.js')}}"></script>
    <!-- Popper js -->
    <script src="{{ asset ('assets/blog/js/popper.min.js')}}"></script>
    <!-- Bootstrap js -->
    <script src="{{ asset ('assets/blog/js/bootstrap.min.js')}}"></script>
    <!-- Plugins js -->
    <script src="{{ asset ('assets/blog/js/plugins.js')}}"></script>
    <!-- Active js -->
    <script src="{{ asset ('assets/blog/js/active.js')}}"></script>
